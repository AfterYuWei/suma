...
export function LogViewer({ containerId }: { containerId: string }) {
  ...
  useEffect(() => {
    ...
    const socket = new WebSocket(`${protocol}//${location.host}/ws/containers/${containerId}/logs?tail=500`)
