...
const zh = {
  overview: '概览', containers: '容器', compose: 'Compose', projects: '项目', continuousDelivery: '持续交付', images: '镜像', networks: '网络', volumes: '存储卷',
  ...
  language: '语言', chinese: '中文', english: 'English', appearance: '外观', chooseTheme: '界面主题',
  ...
  removeProject: '删除 Compose 项目', removeProjectDescription: '将删除项目容器、网络、孤立容器和托管文件；命名卷默认保留。',
...
const english: Record<TranslationKey, string> = {
  overview: 'Overview', containers: 'Containers', compose: 'Compose', projects: 'Projects', continuousDelivery: 'Continuous Delivery', images: 'Images', networks: 'Networks', volumes: 'Volumes',
  ...
  language: 'Language', chinese: '中文', english: 'English', appearance: 'Appearance', chooseTheme: 'Interface theme',
  ...
  removeProject: 'Remove Compose project', removeProjectDescription: 'Project containers, networks, orphans, and managed files are removed; named volumes are preserved by default.',
